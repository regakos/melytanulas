...
How to run pipeline:
1. If you don't wan't to run the train container you have to download our trained model from this link: https://drive.google.com/file/d/1ugKA8FFKcFcv-eWKrP6yO4gaTKeXN38S/view?usp=drive_link. Paste it into your model directory, next to "pasteOurModelhere.txt".
